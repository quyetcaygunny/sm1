...
namespace SM\SU\Block\Adminhtml\Brand;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \SM\SU\Model\ResourceModel\Brand\Grid\CollectionFactory $collectionFactory,
        array $data = []
    )
    {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'small_image',
                'renderer' => '\SM\SU\Block\Adminhtml\Brand\Grid\Renderer\Image',
                'sortable' => false,
                'filter' => false
            ]
        );
