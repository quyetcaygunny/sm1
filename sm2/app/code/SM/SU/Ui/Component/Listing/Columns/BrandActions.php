...
namespace SM\SU\Ui\Component\Listing\Columns;

use Magento\Framework\View\Element\UiComponent\ContextInterface;
use Magento\Framework\View\Element\UiComponentFactory;
use Magento\Ui\Component\Listing\Columns\Column;
use SM\SU\Block\Adminhtml\Brand\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class BrandActions extends Column
{
    const BRAND_URL_PATH_EDIT = 'sumup/brand/edit';
    const BRAND_URL_PATH_DELETE = 'sumup/brand/delete';
