<?php
namespace SM\SU\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected $_eventPrefix = 'sm_su_category_collection';
    ...
    {
        $this->_init('SM\SU\Model\Category', 'SM\SU\Model\ResourceModel\Category');
    }
    ...
    public function getRootId()
    {
        ...
        /** @var \SM\SU\Helper\Category $helper */
        $helper = $objectManager->get('\SM\SU\Helper\Category');
